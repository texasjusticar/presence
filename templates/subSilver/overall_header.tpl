			...
			<tr> 
				...
				<table cellspacing="0" cellpadding="2" border="0">
					<tr> 
						...
						&nbsp;<a href="{U_DISCIPLINES}" class="mainmenu"><img src="templates/subSilver/images/logo_phpBB.gif" width="12" height="13" border="0" alt="{L_DISCIPLINES}" hspace="3" />{L_DISCIPLINES}</a></span>&nbsp;
