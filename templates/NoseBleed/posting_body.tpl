...
<table cellspacing="1" class="posting_body">
	...
	<tr> 
		...
		<td class="row2 two"><input type="text" class="post postbig" tabindex="1" name="username" maxlength="25" value="{USERNAME}" /></td>
	</tr>
	<!-- END switch_username_select -->
	<!-- BEGIN switch_privmsg -->
	<tr> 
		<td class="row1 one">{L_USERNAME}:</td>
		<td class="row2 two"><input type="text" class="post postbig" name="username" maxlength="25" tabindex="1" value="{USERNAME}" />&nbsp;<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="button" onclick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250, resizable=yes, WIDTH=400'); return false;" /></td>
	</tr>
	<!-- END switch_privmsg -->
	<tr> 
		<td class="row1 one">{L_SUBJECT}:</td>
		<td class="row2 two"><input type="text" name="subject" maxlength="60" tabindex="2" class="post postbiggest" value="{SUBJECT}" /></td>
	</tr>
	<tr> 
		...
		<td class="row2 four">
			...
			<textarea name="message" rows="15" cols="35" tabindex="3" class="post postbiggest" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
		</td>
	</tr>
	<tr> 
	...
	{POLLBOX} 
	<tr> 
		<td class="row3 pad4 txtcenter" colspan="2">{S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="button" value="{L_PREVIEW}" />&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="button" value="{L_SUBMIT}" /></td>
	</tr>
</table>
</form>
